This is the core Wami library.  It provides the necessary base classes
of a web application that can be hosted on a such as Tomcat 5.5 to
provide a Javascript API for speech web-interfaces.  The
...
Alternatively, you can override methods in these classes to customize
an domain-specific speech application with server-side functionality.
